--[[
Cảm Ơn Bạn Đã Sử Dụng script của Liêm 
]]--
...
local Library = Update:Window("Liem Hub","2.0",Enum.KeyCode.RightControl);
...
Main:Label("Makori Hub By Liem Hub")
